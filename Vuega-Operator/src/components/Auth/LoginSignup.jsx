        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs">Technical Operator Portal</p>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div>
              <h1 className="text-v-text text-xl font-bold">Vuega</h1>
              <p className="text-v-text-muted text-xs">Technical Operator Portal</p>
            </div>
          </div>

          <div className="mb-8">
            <h2 className="text-2xl font-bold text-v-text">Welcome back</h2>
            <p className="text-v-text-muted text-sm mt-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {error && (
              <div className="bg-v-critical-light border border-v-critical-border text-v-critical text-sm px-4 py-3 rounded-lg">
                {error}
              </div>
            )}

            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-v-text-secondary">
                Email address
              </label>
              <input
                type="email"
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="text-sm text-v-text-muted hover:text-v-text font-medium transition-colors"
                >
                  Forgot password?
                </button>
              </div>
          ...
          <p className="text-center text-v-text-muted text-xs mt-8">
