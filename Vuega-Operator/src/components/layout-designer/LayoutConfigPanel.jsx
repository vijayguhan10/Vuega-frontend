...
export default function LayoutConfigPanel({
  ...
  return (
    <aside className="w-full lg:w-72 xl:w-80 shrink-0 bg-v-primary-bg border border-v-border rounded-xl p-5 space-y-6 self-start">
      {/* Header */}
      <div>
        <h3 className="text-sm font-bold text-v-text tracking-tight">Layout Configuration</h3>
        <p className="text-[11px] text-v-text-muted mt-0.5">Define the template grid</p>
      </div>
      ...
      <label className="flex items-center gap-3 cursor-pointer group">
        ...
        <span className="text-xs font-medium text-v-text-secondary group-hover:text-v-text transition-colors">
          Upper Deck
        </span>
      </label>
      ...
      <div className="space-y-2">
        <button
          ...
          className="w-full py-2.5 rounded-lg text-sm font-semibold bg-v-accent hover:bg-v-accent-hover text-v-text border border-v-accent-border transition-colors shadow-sm"
        >
        ...
        {isGenerated && (
          <>
            <button
              ...
              className="w-full py-2 rounded-lg text-xs font-medium bg-v-secondary hover:bg-v-secondary-hover text-v-text-secondary border border-v-secondary-border transition-colors"
            >
              Auto Renumber
            </button>
            ...
            <div className="flex gap-2">
              <button
                onClick={undo}
                disabled={!canUndo}
                className="flex-1 py-2 rounded-lg text-xs font-medium bg-v-primary-bg border border-v-border text-v-text-secondary hover:bg-v-secondary disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
              >
                ↩ Undo
              </button>
              <button
      ...
      {isGenerated && (
        <div className="space-y-2">
          <button
            onClick={saveLayout}
            className="w-full py-2.5 rounded-lg text-sm font-semibold bg-v-text text-white hover:bg-v-text-secondary transition-colors shadow-sm"
          >
            Save Template
          </button>
