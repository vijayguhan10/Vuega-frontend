    ...
    return (
      <div className="flex-1 flex items-center justify-center min-h-100">
        <div className="text-center space-y-3">
          ...
          <div>
            <p className="text-sm font-medium text-v-text">No layout generated</p>
  ...
  return (
    <div className="flex-1 overflow-auto p-4 md:p-6">
      ...
      <div className="flex items-center gap-4 mb-6 flex-wrap">
        <span className="text-xs font-medium text-v-text-secondary bg-v-secondary px-3 py-1.5 rounded-lg border border-v-secondary-border">
        ...
        {upperDeck && (
          <div className="flex rounded-lg border border-v-border overflow-hidden">
            ...
            <button
              ...
              className={`px-3 py-1.5 text-xs font-medium border-l border-v-border transition-colors ${
                activeDeck === 'upper'
                  ? 'bg-v-accent text-v-text'
                  : 'bg-v-primary-bg text-v-text-muted hover:bg-v-secondary'
              }`}
        ...
        <span className="text-[10px] text-v-text-muted ml-auto hidden md:block">
