  ...
  return (
    <div className="bg-v-primary-bg border border-v-border rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-v-border flex items-center gap-2">
        ...
        <div>
          <h3 className="text-v-text text-lg font-bold">Maintenance Alerts</h3>
          ...
          return (
            ...
            >
              ...
              <div className="text-right">
                <span
                  className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium ${style.bg} ${style.text} border ${style.border}`}
                >
                  {alert.expiryDate}
                </span>
              </div>
      ...
      <div className="px-6 py-3 border-t border-v-border bg-v-secondary/30 flex justify-center">
        <button className="text-sm font-semibold text-v-text-secondary hover:text-v-text transition-colors">
