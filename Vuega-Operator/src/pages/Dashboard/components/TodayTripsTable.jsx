  ...
  return (
    <div className="bg-v-primary-bg border border-v-border rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-v-border flex justify-between items-center">
        <div>
          <h3 className="text-v-text text-lg font-bold">Today's Trips</h3>
          <p className="text-v-text-muted text-xs mt-0.5">
            {todayTrips.length} trips scheduled for today
          </p>
        </div>
        <button className="flex items-center gap-1.5 text-v-text-muted hover:text-v-text text-sm font-medium transition-colors px-3 py-1.5 rounded-lg hover:bg-v-secondary">
          <FaFilter size={16} />
          Filter
        </button>
      </div>
            ...
            {todayTrips.map((trip) => (
              ...
              >
                ...
                <td className="px-6 py-4 text-right">
                  <button className="inline-flex items-center gap-1 text-v-text-muted hover:text-v-text text-xs font-medium px-2.5 py-1.5 rounded-lg hover:bg-v-accent/40 transition-colors">
                    <FaEye size={14} />
                    View
                  </button>
                </td>
