...
const MetricsSection = () => {
 ...
 <div>
 <p className="text-v-text-muted font-medium">
 {metric.label}
 </p>
 <h3 className="text-v-text font-bold mt-1">
 {metric.value}
 </h3>
 </div>
 ...
 <span className=" font-semibold text-v-text bg-v-accent px-1.5 py-0.5 rounded">
 {metric.change.value}
 </span>
 )}
