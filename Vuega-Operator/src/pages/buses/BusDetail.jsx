    ...
    return (
      <div className="max-w-[1360px] mx-auto flex flex-col items-center justify-center h-64 text-center">
        <div className="w-12 h-12 rounded-full bg-v-critical-light flex items-center justify-center mb-4">
          <span className="text-v-critical text-xl">!</span>
        </div>
        <h2 className="text-lg font-semibold text-v-text">Bus Not Found</h2>
        <p className="text-sm text-v-text-muted mt-1">
          The requested bus does not exist.
        </p>
        <button
          onClick={() => navigate("/buses")}
          className="mt-4 px-4 py-2 rounded-lg text-sm font-medium bg-v-accent hover:bg-v-accent-hover text-v-text border border-v-accent-border transition-colors"
        >
          Back to Buses
        </button>
      </div>
  ...
  return (
    <div className="max-w-[1360px] mx-auto flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-v-text-secondary border border-v-border hover:bg-v-secondary hover:border-v-secondary-border transition-colors">
          <FaPencilAlt size={16} />
          Edit Bus
        </button>
      </div>
