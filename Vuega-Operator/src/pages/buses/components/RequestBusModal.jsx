    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Request New Bus">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-semibold text-v-text-secondary uppercase tracking-wider">
            Bus Number Plate
          </label>
          <input
            type="text"
            ...
            required
            className="w-full px-3.5 py-2.5 rounded-lg border border-v-border bg-v-primary-bg text-sm text-v-text placeholder:text-v-text-placeholder focus:outline-none focus:ring-2 focus:ring-v-accent focus:border-v-accent-border transition-colors"
          />
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            onChange={handleChange}
            required
            className="w-full px-3.5 py-2.5 rounded-lg border border-v-border bg-v-primary-bg text-sm text-v-text focus:outline-none focus:ring-2 focus:ring-v-accent focus:border-v-accent-border transition-colors"
          >
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className="w-full px-3.5 py-2.5 rounded-lg border border-v-border bg-v-primary-bg text-sm text-v-text placeholder:text-v-text-placeholder focus:outline-none focus:ring-2 focus:ring-v-accent focus:border-v-accent-border transition-colors resize-none"
          />
        </div>
        ...
        <div className="flex items-center justify-end gap-3 pt-3 border-t border-v-border">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-lg text-sm font-medium text-v-text-secondary border border-v-border hover:bg-v-secondary transition-colors"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="inline-flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-semibold bg-v-accent hover:bg-v-accent-hover text-v-text border border-v-accent-border transition-colors"
          >
