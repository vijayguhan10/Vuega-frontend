  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-v-text">Boarding Points</h3>
        <button
          type="button"
          onClick={addPoint}
          className="text-xs font-medium text-v-accent-dark hover:text-v-accent-hover transition-colors"
        >
          + Add Boarding Point
        </button>
      </div>
      ...
      {points.length === 0 && (
        <p className="text-xs text-v-text-muted py-4 text-center">
        ...
        {points.map((pt) => (
          ...
          >
            ...
            <input
              ...
              className="flex-1 px-3 py-1.5 rounded-lg border border-v-border bg-v-primary-bg text-sm text-v-text placeholder:text-v-text-placeholder focus:outline-none focus:ring-1 focus:ring-v-accent-dark transition"
            />
            ...
            <input
              ...
              placeholder="+0 min"
              className="w-28 shrink-0 px-3 py-1.5 rounded-lg border border-v-border bg-v-primary-bg text-sm text-v-text text-center placeholder:text-v-text-placeholder focus:outline-none focus:ring-1 focus:ring-v-accent-dark transition"
            />
