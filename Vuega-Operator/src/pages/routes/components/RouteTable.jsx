        ...
        return (
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-xs font-medium text-v-accent-dark hover:underline"
            >
              View
            </button>
            ...
            <button
              ...
              className="text-xs font-medium text-v-text-secondary hover:underline"
            >
              Edit
            </button>
            <span className="text-v-border">|</span>
            <button
              ...
              className="text-xs font-medium text-v-critical hover:underline"
            >
