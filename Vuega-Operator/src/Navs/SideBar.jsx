        ...
        <div className="flex flex-col h-full px-4 py-5">
          ...
          <div className="flex items-center justify-between mb-8 px-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-v-text">Vuega</h1>
                <p className="text-[11px] text-v-text-muted leading-tight">
                  Technical Operator
                </p>
              </div>
            </div>
          ...
          {/* Navigation Label */}
          <p className="text-[10px] font-semibold text-v-text-muted uppercase tracking-wider px-3 mb-2">
            Operations
          </p>
          ...
          <div className="mt-auto pt-4 border-t border-v-border">
            <button
              ...
              className="w-full flex items-center gap-3 text-v-critical hover:bg-v-critical-light px-3 py-2.5 rounded-lg font-medium text-sm transition-colors"
            >
